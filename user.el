...
(load-file "~/elisp/semantic-hover-completion.el")
...
(add-to-list 'load-path "~/elisp/cedet/srecode")
(require 'srecode-mode)

(add-to-list 'load-path "~/elisp/ecb")
(require 'ecb)

(add-to-list 'load-path "~/elisp/dist/emacs-eclim.git/")
(require 'eclim)
(setq eclim-auto-save t)
;; (global-eclim-mode)


;; (load-file "~/elisp/color-theme-my-rlx.el")
;; (require 'color-theme)
;; (color-theme-rlx)

(add-to-list 'load-path "~/elisp/dist/org-mode/lisp")
(add-to-list 'load-path "~/elisp/dist/org-mode/contrib/lisp")
...
;; (setq msf-abbrev-root "~/elisp/mode-abbrevs")
